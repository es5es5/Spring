...
/**
 * Servlet implementation class DataRoomDeleteController
 */
@WebServlet("/DataRoomDeleteController")
public class DataRoomDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DataRoomDeleteController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(MemberDAO.getMdao().loginCheck(request, response)) {
			DataRoomDAO.getDrdao().delete(request, response);
		}
