...
/**
 * Servlet implementation class DataRoomRegController
 */
@WebServlet("/DataRoomRegController")
public class DataRoomRegController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DataRoomRegController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(MemberDAO.getMdao().loginCheck(request, response)) {
			DataRoomDAO.getDrdao().reg(request, response);
		}
