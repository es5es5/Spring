...
/**
 * Servlet implementation class SNSReplWriteController
 */
@WebServlet("/SNSReplWriteController")
public class SNSReplWriteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SNSReplWriteController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if(MemberDAO.getMdao().loginCheck(request, response)) {
			SNSDAO.getSdao().writeRepl(request, response);
		}
