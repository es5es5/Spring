...
<body>
	<form action="VoteRegController" name="voteRegForm"
		onsubmit="return voteRegCheck();">
		<table id="voteRegTbl">
			<tr>
				<td colspan="2" id="voteRegInputTd"><input id="voteRegInput"
	...
	<form action="VoteController" method="post">
		<table id="voteArea">
			<tr>
				<td align="center" id="voteTitle" colspan="2">${iv_title }</td>
			</tr>
			<tr>
				<td class="voteTd1">등록자</td>
				<td class="voteTd2">${iv_owner }</td>
			</tr>
			<tr>
				<td class="voteTd1">총 투표수</td>
				<td class="voteTd2">${iv_count }</td>
			</tr>
			<tr>
				<td colspan="2" class="voteTd3" align="center">
					<table id="voteArea2">
						...
						<c:forEach var="vi" items="${ivi_items }">
							<tr>
