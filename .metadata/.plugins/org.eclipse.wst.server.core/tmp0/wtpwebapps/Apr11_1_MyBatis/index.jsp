...
<body>
	<table>
		...
		<c:forEach var="p" items="${products }">
			<tr>
				...
				<td align="center"><img src="img/${p.p_img }"></td>
				<td>${p.p_name }</td>
	...
	<div>
		...
		<form action="RegController" method="post"
			...
			품명 : <input name="p_name"><br> 사진 : <input type="file"
				name="p_img"><br> 가격 : <input name="p_price"><br>
			유통기한: <input name="p_exp"><br> <input type="submit"
				value="등록">
		</form>
		<hr>
		<h2>상품명으로 찾기</h2>
